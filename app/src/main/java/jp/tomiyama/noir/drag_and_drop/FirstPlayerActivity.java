...
//    player = new Player();
    ...
    fab.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        AlertDialog.Builder builder = new AlertDialog.Builder(FirstPlayerActivity.this);
        builder.setMessage("あなたの数字は「" + sumNumber +"」です。\nよろしければOKを押して、Player2に渡してください。")
...
//    editor.apply();
  ...
  public void init(){
    ...
    for(int i = 0; i < 10; i++){
      boolean tempStatus = pref.getBoolean(PLAYER1_INDEX+i,false);
